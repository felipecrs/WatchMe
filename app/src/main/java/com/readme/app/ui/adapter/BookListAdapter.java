package com.readme.app.ui.adapter;
...
public class BookListAdapter extends RecyclerView.Adapter<BookListAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View itemView) {
            super(itemView);
            txtTitle = itemView.findViewById(R.id.list_book_txtTitle);
            txtAuthor = itemView.findViewById(R.id.list);
            coverImageView = itemView.findViewById(R.id.list_book_image_cover);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.list_book, parent, false);
