...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = AppDatabase.getInstance(this);
		...
		final MaterialButton submitQuery = new MaterialButton(AndroidDatabaseManager.this);
		...
		previous = new MaterialButton(AndroidDatabaseManager.this);
		previous.setText("Previous");
		
		previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
		previous.setLayoutParams(secondrowlp);
		next = new MaterialButton(AndroidDatabaseManager.this);
		next.setText("Next");
		...
		final MaterialButton customQuery = new MaterialButton(AndroidDatabaseManager.this);
